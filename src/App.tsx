  ...
  return (
    <div className="App bg-off-white py-4 md:py-9 font-plus-jakarta">
      ...
      <main className="pt-8 md:pt-16">
        <h1 className="mx-4 md:mx-10 text-black text-4xl-mob md:text-5xl-dsk text-center">
        ...
        <div className="mx-4 flex flex-col items-center md:flex-row md:justify-between md:items-start">
          <img
            src={personImg}
            alt=""
            className="w-5/6 mb-11 md:w-3/6 md:-ml-16 md:mr-16 md:mb-0"
          />
        ...
        <p className="text-center text-black text-2xl-mob mb-9 md:mb-14 md:text-3xl-dsk">
          My Work
        </p>
        <div
          id="imageDisplay"
        ...
        <div className="mx-4 flex flex-col items-center bg-black px-6 py-12 rounded-lg md:pt-14 md:pb-16 md:mx-10 md:px-24">
          <p className="text-off-white text-3xl-mob text-center md:text-3xl-dsk">
            Book a call with me
          </p>
